...
const ROUTE_MATRIX: MatrixEntry[] = [
  ...
  { path: '/app/api/audit/route.ts', methods: ['GET'], group: 'wrapped-auth' },
  { path: '/app/api/dashboards/document-compliance/route.ts', methods: ['GET'], group: 'wrapped-auth' },
  { path: '/app/api/dashboards/pm/filters/route.ts', methods: ['GET', 'PUT', 'POST'], group: 'wrapped-auth' },
  { path: '/app/api/dashboards/pm/route.ts', methods: ['GET'], group: 'wrapped-auth' },
  { path: '/app/api/dashboards/portfolio/export/route.ts', methods: ['POST'], group: 'wrapped-auth' },
  { path: '/app/api/dashboards/portfolio/filters/route.ts', methods: ['GET', 'PUT', 'POST'], group: 'wrapped-auth' },
  { path: '/app/api/dashboards/portfolio/route.ts', methods: ['GET'], group: 'wrapped-auth' },
  { path: '/app/api/document-catalog/[id]/route.ts', methods: ['GET', 'PATCH'], group: 'wrapped-auth' },
  { path: '/app/api/document-catalog/route.ts', methods: ['GET', 'POST'], group: 'wrapped-auth' },
  { path: '/app/api/document-templates/[id]/route.ts', methods: ['GET', 'PATCH'], group: 'wrapped-auth' },
  { path: '/app/api/document-templates/route.ts', methods: ['GET', 'POST'], group: 'wrapped-auth' },
  { path: '/app/api/projects/[id]/benefits/route.ts', methods: ['GET', 'POST', 'PATCH'], group: 'wrapped-project' },
  { path: '/app/api/projects/[id]/dependencies/route.ts', methods: ['GET', 'POST', 'PATCH'], group: 'wrapped-project' },
  { path: '/app/api/projects/[id]/document-checklist/[itemId]/route.ts', methods: ['GET', 'PATCH'], group: 'wrapped-project' },
  { path: '/app/api/projects/[id]/document-checklist/route.ts', methods: ['GET'], group: 'wrapped-project' },
  { path: '/app/api/projects/[id]/fiscal-budget/[budgetId]/adjustments/route.ts', methods: ['POST'], group: 'wrapped-project' },
  { path: '/app/api/projects/[id]/fiscal-budget/route.ts', methods: ['GET', 'POST', 'PATCH'], group: 'wrapped-project' },
  { path: '/app/api/projects/[id]/roi/route.ts', methods: ['GET'], group: 'wrapped-project' },
  { path: '/app/api/projects/[id]/weekly-reports/[reportId]/correct/route.ts', methods: ['POST'], group: 'wrapped-project' },
  { path: '/app/api/projects/[id]/weekly-reports/[reportId]/route.ts', methods: ['GET', 'PATCH'], group: 'wrapped-project' },
  { path: '/app/api/projects/[id]/weekly-reports/[reportId]/submit/route.ts', methods: ['POST'], group: 'wrapped-project' },
  { path: '/app/api/projects/[id]/weekly-reports/route.ts', methods: ['GET'], group: 'wrapped-project' },
  { path: '/app/api/weekly-periods/[periodId]/export/preview/route.ts', methods: ['POST'], group: 'wrapped-auth' },
  { path: '/app/api/weekly-periods/[periodId]/export/route.ts', methods: ['POST'], group: 'wrapped-auth' },
  { path: '/app/api/weekly-periods/[periodId]/tracking/route.ts', methods: ['GET'], group: 'wrapped-auth' },
  { path: '/app/api/weekly-periods/config/route.ts', methods: ['GET', 'PUT'], group: 'wrapped-auth' },
  { path: '/app/api/weekly-periods/route.ts', methods: ['GET', 'POST'], group: 'wrapped-auth' },

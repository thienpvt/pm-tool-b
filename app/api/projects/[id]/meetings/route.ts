...
export async function GET(req: NextRequest, { params }: Params) {
  ...
  try {
    return NextResponse.json(await listMeetings(id, actorOf(user)));
  } catch (e) {
    return mapError(e);
  }
}
...
export async function POST(req: NextRequest, { params }: Params) {
  ...
  try {
    ...
    return NextResponse.json(await createMeeting(id, actorOf(user), body), { status: 201 });
  } catch (e) {
    return mapError(e);
  }
}
...
export async function PUT(req: NextRequest, { params }: Params) {
  ...
  try {
    ...
    return NextResponse.json(await updateMeeting(id, actorOf(user), rowId, fields));
  } catch (e) {
    return mapError(e);
  }
}
...
export async function DELETE(req: NextRequest, { params }: Params) {
  ...
  try {
    await deleteMeeting(id, actorOf(user), searchParams.get('rowId') ?? '');

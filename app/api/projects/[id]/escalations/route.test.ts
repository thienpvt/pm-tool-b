...
const { projectAccessRow, listEscalationsRepo } = vi.hoisted(() => ({
...
describe('GET /api/projects/[id]/escalations', () => {
  beforeEach(() => vi.clearAllMocks());
  const params = { params: Promise.resolve({ id: '7' }) };
  const req = () => new NextRequest('http://localhost/api/projects/7/escalations');

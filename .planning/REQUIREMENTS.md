...
- [ ] **CPMO-01**: CPMO can see obligated-project counts and Not submitted / Draft / Submitted / Overdue / Late for a period
- [ ] **CPMO-02**: CPMO can filter the tracking grid by period, status, lateness, PM, stage, RAG, and technology-council issues, then open a report
- [ ] **CPMO-03**: CPMO can tick-select projects, preview consolidation, reorder projects, and export an editable consolidated pack (Excel/Word/PPT as already supported)

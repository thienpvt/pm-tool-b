...
- [ ] 09-01-PLAN.md — Tracer: timeline mapping tenant isolation (schema, service assert, 403)
...
- [ ] 09-03-PLAN.md — Jira JQL presets and sync mapping tenant isolation
...
| 9. Mapping Table Tenant Isolation | v2.0 | 0/3 | Not started | - |

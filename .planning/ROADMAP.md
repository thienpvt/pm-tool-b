...
- [x] 04-01-PLAN.md — Service substrate (typed errors, assertProjectAccess, serviceErrorResponse) + risks reference service

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 04-02-PLAN.md — Close the 6 unauthenticated export/import leaks + config POST admin gate
...
- [x] 05-02-PLAN.md — Convert remaining 17 app/api/projects/[id]/** routes onto withProjectAccess

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 05-03-PLAN.md — Wire Zod schemas into tree-A (12 projects/[id]/** resources) and tree-B (~14 non-converted routes)
...
- [x] 07-04-PLAN.md — Decompose `app/projects/[id]/report/page.tsx` (UI-04)
- [x] 07-05-PLAN.md — Decompose `app/projects/[id]/milestones/page.tsx` (UI-05)

**Wave 3** *(parallel)*

- [x] 07-06-PLAN.md — Decompose `app/portfolio/roadmap/page.tsx` (UI-06)
- [x] 07-07-PLAN.md — Decompose `components/timeline/ImportMappingDialog.tsx` in place (UI-07)

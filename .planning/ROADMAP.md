...
- [x] 24-02-PLAN.md — Audit backend split

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 24-03-PLAN.md — Weekly backend plus P3 wrapper-stays
...
- [x] 24-06-PLAN.md — Projects UI/backend (except weekly, checklist, reports)

**Wave 7** *(blocked on Wave 6 completion)*

- [x] 24-07-PLAN.md — Reports module including D-11 /portfolio/report

**Wave 8** *(blocked on Wave 7 completion)*

- [x] 24-08-PLAN.md — Jira/import dialogs and APIs

**Wave 9** *(blocked on Wave 8 completion)*

- [x] 24-09-PLAN.md — Admin module plus D-07 companies

**Wave 10** *(blocked on Wave 9 completion)*

- [x] 24-10-PLAN.md — Operations module plus D-07 sweep
...
- [x] 25-02-PLAN.md — pickAllowed + transactional Kysely ALS

**Wave 3** *(blocked on Wave 2)*

- [x] 25-03-PLAN.md — dashboards + auth.repo + settings.repo

**Wave 4** *(blocked on Wave 3)*

- [x] 25-04-PLAN.md — admin module repos

**Wave 5** *(blocked on Wave 4)*

- [x] 25-05-PLAN.md — documents module repos

**Wave 6** *(blocked on Wave 5)*

- [x] 25-06-PLAN.md — jira import-mapping + operations

**Wave 7** *(blocked on Wave 6)*

- [x] 25-07-PLAN.md — programs, fiscal-budget, resources

**Wave 8** *(blocked on Wave 7)*

- [x] 25-08-PLAN.md — portfolio.repo.ts
...
- [x] 25-10-PLAN.md — weekly-reports.repo.ts

**Wave 11** *(blocked on Wave 10)*

- [x] 25-11-PLAN.md — projects W9a reads (budget, bugs, documents, holidays, financial-benefits, milestones)

**Wave 12** *(blocked on Wave 11)*

- [x] 25-12-PLAN.md — projects W9a remaining reads

**Wave 13** *(blocked on Wave 12)*

- [x] 25-13-PLAN.md — W9b pickAllowed (projects, activities, risks)

**Wave 14** *(blocked on Wave 13)*

- [x] 25-14-PLAN.md — W9b pickAllowed (issues, meetings, escalations, team)

**Wave 15** *(blocked on Wave 14)*

- [x] 25-15-PLAN.md — cleanup SET helper; repo getKysely gate
...
- [x] 26-02-PLAN.md — Remaining Sidebar chrome routes (exclude login, landing, operations, budget)
- [x] 26-03-PLAN.md — Cold-start p95 budget artifact

**Wave 1**

- [x] 26-01-PLAN.md — chrome foundation + pilots

**Wave 2** *(blocked on Wave 1)*

- [x] 26-02-PLAN.md — remaining Sidebar routes

**Wave 3** *(blocked on Wave 2; isolation none on main tree)*

- [x] 26-03-PLAN.md — getDb cold-start budget
...
- [x] 27-01-PLAN.md — NIT-01 contract tests for listPeriodShells and listOpenProjectDependencies

**Wave 2** *(blocked on Wave 1; isolation none on main tree)*

- [x] 27-02-PLAN.md — NIT-02 skip audit_logs on no-op milestone PATCH

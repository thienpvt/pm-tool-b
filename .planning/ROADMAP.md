...
- [x] 11-04-PLAN.md — Stakeholder history nested API and listProjectStakeholders

**Wave 3** *(blocked on Wave 2 plan 11-02)*

- [x] 11-03-PLAN.md — PM assignment windows, D-14 backfill, rewire all three PM lookup sites

**Wave 4** *(blocked on 11-02, 11-03, 11-04)*

- [x] 11-05-PLAN.md — Existing create/detail fields so CPMO can operate (no UI-SPEC)
...
- [x] 12-02-PLAN.md — Unique RAID codes and HTTP DELETE → deactivate

**Wave 3** *(blocked on Wave 1 and Wave 2)*

- [x] 12-03-PLAN.md — Due-date history, RAID-05 order, High/tech-council lists
...
- [x] 13-01-PLAN.md — Tracer: company weekly config, period create, obligated shells, CPMO list
...
- [x] 13-03-PLAN.md — RAID/milestone snapshots, progress/RAG sync, list helpers, access tests
...
- [x] 14-03-PLAN.md — xlsx/docx/pptx pack, weekly_export_logs insert, POST export
...
- [x] 15-01-PLAN.md — Tracer: fiscal DDL, VND parsers, computed remaining/utilization, create/GET/PATCH actual, append-only adjustments

**Wave 2** *(blocked on Wave 1; 15-02 and 15-03 parallel)*

- [x] 15-02-PLAN.md — Financial + nonfinancial benefits and honest year-level ROI GET
- [x] 15-03-PLAN.md — Cross-project dependencies create/list/end, validation, auditLog
...
- [x] 16-01-PLAN.md — Tracer: DDL, KPI helpers, CPMO GET portfolio (tiles, charts, list, drill-downs, AND filters)
...
- [x] 16-03-PLAN.md — PM dashboard assignment list, weekly/milestone/RAID actions, deep links
...
- [x] 17-02-PLAN.md — Template versioning + checklist PATCH HTTPS/status rules
- [x] 17-03-PLAN.md — create/stage hooks, 409 mandatory warning, compliance GET
...
Plans:
- [ ] 18-01-PLAN.md — GET /api/audit, append-only list, immutability
- [ ] 18-02-PLAN.md — RAID create/update audit coverage
...
| 18. Append-Only Audit Log | v2.0 | 0/3 | Not started | - |

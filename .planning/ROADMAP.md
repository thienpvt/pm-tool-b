...
- [ ] **Phase 1: Test Harness** - Stand up Vitest so every later layer lands with tests, not a promise to add them
- [ ] **Phase 2: Repository Layer** - Move every SQL statement into repository modules with explicit scoping and column allowlists
...
|-------|----------------|--------|-----------|
| 1. Test Harness | 0/TBD | Not started | - |
